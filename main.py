...
@app.route('/')
def home():
    return "I'am BD Coder File Host bot"
...
# --- Configuration ---
TOKEN = '8280227665:AAHKXTWFewO6fG3kZBOuInlGTatRi-Zjc-k' # Replace with your actual token
OWNER_ID = 7118004768 # Replace with your Owner ID
ADMIN_ID = 7118004768 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = 'Mentor_Badhon' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 't.me/BDFFX' # Replace with your update channel link
